...
class Bestellung
{
    ...
    {
        include 'C:\xampp2\htdocs\dashboard\Blumenshop\src\Bestellung\Controller\StraussAnzeigenController.php';
    }

    private function blumeinStraussHinzufuegen()
    {
        include 'C:\xampp2\htdocs\dashboard\Blumenshop\src\Bestellung\Controller\BlumeInStraussHinzufuegenController.php';

    }

    private function blumeAusStraussEntfernen()
    {
        include 'C:\xampp2\htdocs\dashboard\Blumenshop\src\Bestellung\Controller\BlumeAusStraussEntfernenController.php';
    }
