...
class BlumeUpdatenController
{
    ...
    public function blumeUpdaten($blumename)
    {
        ...
        include 'C:\xampp2\htdocs\dashboard\Blumenshop\src\Besitzer\Views\blume\blumeUpdaten.php';
    }
}
...
if (empty($_POST['UpdateBlume'])) {
    echo '<div>';
    echo '<a href="/dashboard/Blumenshop/src/Besitzer/index.php">Zurück ins Besitzermenü</a>';
    echo '</div>';
}
